    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <Row className="g-gs">
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/alerts`} className="card  text-soft">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/accordions`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/badges`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/buttons`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/button-group`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/cards`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/dropdowns`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/modals`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/pagination`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/spinner`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/tabs`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/toast`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/table-basic`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/table-special`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/form-elements`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/components/form-layouts`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
            ...
            <Col lg={6}>
              <Link to={`${process.env.PUBLIC_URL}/charts/chartjs`} className="card  text-soft">
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
